...
wheelWidth     = 3;     // The width (or thickness) of the wheel at the rim.
...
rimHeight      = 10;        // The height of the rim portion of the wheel. 
timingHoles    = 20;        // The number of timing holes to carve into the rim
