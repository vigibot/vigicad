...
tireID         = 77;    // Internal diameter (ID) -- How wide is the inside opening? 
tireStretch    = 1;     // Circumferential stretch percentage (usually 1 + 0-5%, e.g. 1.02) -- How 
...
rimHeight      = 4;         // The height of the rim portion of the wheel. 
...
spokeWidth        = 6;          // This is how wide each spoke is.
...
hubHeight            = 9;     // The total height of the hub
hubZOffset           = -6;    // The Z position of the hub, negative numbers from the surface of the wheel 
...
shaftDiameter        = 3.1;        // The diameter of the motor shaft
shaftFlatDiameter    = 2.6;        // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.
